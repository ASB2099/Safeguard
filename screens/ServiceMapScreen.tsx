...
const ServiceMapScreen: React.FC<ServiceMapScreenProps> = ({ navigateTo, service }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-[#F1F3F6] dark:bg-gray-900">
      <Header title={service.name} onBack={() => navigateTo(Page.Services)} />
      ...
      <div className="bg-white dark:bg-gray-800 p-4 border-t border-gray-200 dark:border-gray-700">
        <div className="text-center mb-4">
            <h3 className="font-bold text-lg text-gray-800 dark:text-gray-100">{service.name}</h3>
