...
const LocationScreen: React.FC<LocationScreenProps> = ({ navigateTo, theme, toggleTheme, location, locationError, locationLoading, userLocation }) => {
  ...
  const LocationPinIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-green-500 dark:text-red-500" viewBox="0 0 20 20" fill="currentColor">
  ...
  return (
    <div className="flex flex-col h-full bg-transparent">
      ...
      {locationError && (
        <div className="bg-red-100/80 dark:bg-red-900/50 backdrop-blur-md border-l-4 border-red-500 dark:border-red-600 text-red-700 dark:text-red-200 p-4 m-4 rounded-md animate-fadeIn" role="alert">
        ...
        {locationLoading ? (
           <div className="w-full h-full flex flex-col items-center justify-center bg-white/60 dark:bg-black/60">
             <div className="relative flex items-center justify-center w-24 h-24">
                <div className="absolute w-full h-full rounded-full bg-green-500/20 dark:bg-red-500/20 animate-radar-scan dark:animate-[radar-scan-dark_1.5s_infinite_cubic-bezier(0.215,0.610,0.355,1)]"></div>
                <LocationPinIcon />
             </div>
