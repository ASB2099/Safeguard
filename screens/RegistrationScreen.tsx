      ...
      <div className="flex-grow flex flex-col items-center justify-center p-8">
        ...
        <form onSubmit={handleRegister} className="w-full max-w-sm space-y-6">
          <div className="animate-fadeInUp" style={{ animationDelay: '200ms' }}>
            <label htmlFor="name" className="block text-sm font-medium text-light-text dark:text-dark-text">Full Name</label>
            <input
              id="name"
              type="text"
              value={name}
          ...
          <div className="animate-fadeInUp" style={{ animationDelay: '300ms' }}>
            <label htmlFor="email" className="block text-sm font-medium text-light-text dark:text-dark-text">Email Address</label>
            <input
              id="email"
              type="email"
              value={email}
