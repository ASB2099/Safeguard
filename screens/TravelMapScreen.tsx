...
const TravelMapScreen: React.FC<TravelMapScreenProps> = ({ navigateTo, service, theme, toggleTheme, location }) => {
  ...
  if (!location) {
    return (
        <div className="flex flex-col h-full bg-gradient-page">
            <Header title={t('error_title')} onBack={() => navigateTo(Page.Travel)} theme={theme} toggleTheme={toggleTheme} page={Page.TravelMap} />
  ...
  return (
    <div className="flex flex-col h-full bg-gradient-page">
      <Header title={service.name} onBack={() => navigateTo(Page.Travel)} theme={theme} toggleTheme={toggleTheme} page={Page.TravelMap} showLanguageSwitcher/>
