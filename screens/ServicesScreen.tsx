...
const ServicesScreen: React.FC<ServicesScreenProps> = ({ navigateTo, viewServiceOnMap, theme, toggleTheme }) => {
  return (
    <div className="flex flex-col h-full bg-gray-50 dark:bg-gray-900">
      <Header title="Nearby Services" onBack={() => navigateTo(Page.Home)} theme={theme} toggleTheme={toggleTheme} />
      
      <div className="flex-grow overflow-y-auto p-4 space-y-3">
        <p className="text-sm text-gray-600 dark:text-gray-400 px-2 pb-2 animate-fadeIn">Select a service to view it on the map.</p>
